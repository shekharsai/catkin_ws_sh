...
bool CobraCenterPoseCallback(std_srvs::Trigger::Request &req, std_srvs::Trigger::Response &res);
...
int main(int argc, char **argv){
	...
	ros::ServiceServer CobraCenter = n.advertiseService("cobra_center_pose", &CobraCenterPoseCallback);
...
bool CobraCenterPoseCallback(std_srvs::Trigger::Request &req, std_srvs::Trigger::Response &res) {
    ...
    //pn.param<std::string>("cobra_center", EndPositionName, "pre_grasp2");
    moveit::planning_interface::MoveGroup group("arm");
    group.setPlanningTime(10.0);
    group.setNumPlanningAttempts(50);
    group.setPlannerId("RRTConnectkConfigDefault");
    ...
    group.setStartStateToCurrentState();
    group.setNamedTarget("cobra_center");
    moveit::planning_interface::MoveGroup::Plan EndPosPlan;
