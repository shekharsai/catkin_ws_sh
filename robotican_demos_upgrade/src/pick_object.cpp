...
int main(int argc, char **argv) {
    ...
    ros::ServiceClient sw_client = n.serviceClient<robotican_demos_upgrade::switch_topic>("switch_pcl_topic");
    ...
    if (pick_client.call(pick_srv)) {
        ...
        if (pick_srv.response.success)
        {
            ...
            std_msgs::String msg;
            if(pick_srv.response.message.c_str()=="Preempted")
                msg.data = "failed pick";
            else
                msg.data = "finish pick";
